...
export default {
  ...
  async postHotel(form: FormDataReader) {
    ...
    return await client.query(
      `insert into hotel (NombreHotel, TelefonoHotel, Direccion, Estrellas, Regimen, WiFi, Parking, Piscina, CodigoPostal) 
       values ('${data.fields.Nombre}', ${data.fields.Telefono}, '${data.fields.Direccion}', ${data.fields.Estrellas}, '${data.fields.Regimen}', ${data.fields.Wifi}, ${data.fields.Parking}, ${data.fields.Piscina}, ${data.fields.CodigoPostal})`,
    );
  },
};
